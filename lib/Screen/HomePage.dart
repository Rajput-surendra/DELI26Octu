...
import 'package:deli/Helper/AppBtn.dart';
import 'package:deli/Helper/Color.dart';
import 'package:deli/Helper/Constant.dart';
import 'package:deli/Helper/Session.dart';
import 'package:deli/Helper/SimBtn.dart';
import 'package:deli/Helper/String.dart';
import 'package:deli/Helper/widgets.dart';
import 'package:deli/Model/Model.dart';
import 'package:deli/Model/Section_Model.dart';
import 'package:deli/Provider/CartProvider.dart';
import 'package:deli/Provider/CategoryProvider.dart';
...
import 'package:deli/Screen/SellerList.dart';
import 'package:deli/Screen/SubCategory.dart';
import 'package:deli/Screen/search_location.dart';
  ...
  void getSetting() {
    ...
    apiBaseHelper.postAPICall(getSettingApi, parameter).then((getdata) async {
      ...
      if (!error) {
        ...
        CUR_CURRENCY = getdata["data"]["currency"][0];
        ...
        print("this is my current currency $CUR_CURRENCY");
